				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<form action="#" method="post">
								<input type="search" placeholder="Dich vu..." name="search" required="">
						...
						<div class="left-side border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Danh muc dich vu</h3>
							<ul>
							<?php
							...
							?>
								<li>
									<span class="span"><a href="danhmucdichvu.php?id=<?php echo $row_category_sidebar['category_id'] ?>"><?php echo $row_category_sidebar['category_name'] ?></a></span>
								</li>
								<?php
									}
								?>
						...
						<div class="f-grid py-2">
							<h3 class="agileits-sear-head mb-3">Dich vu tot nhat</h3>
							<div class="box-scroll">
								<div class="scroll">
									<?php
										$sql_product_sidebar = mysqli_query($conn, "SELECT * FROM tbl_sanpham WHERE sanpham_hot = '0' ORDER BY sanpham_id DESC");
